...
-- Region IDs follow GetCurrentRegion(): 1=US, 2=KR, 3=EU, 4=TW, 5=CN.
-- These sets remain in the transmog API outside their distribution region, so
-- treat them as unobtainable there while preserving them on the correct client.
addon.MiscSets.REGION_RESTRICTED_SETS = {
	[5335] = 5, -- Scorching Conqueror (China region only)
}
...
-- Stable set IDs avoid relying on English API descriptions for promotions.
-- Text matching remains as a forward-compatible fallback for future sets.
addon.MiscSets.PROMOTION_SETS = {
	[1902] = true, -- Renowned Explorer's Attire / Recruit-A-Friend
	[1998] = true, -- Renowned Explorer recolor
	[1999] = true, -- Renowned Explorer recolor
	[1903] = true, -- Wendigo Woolies / BlizzCon
	[1913] = true, -- Vestments of the Eternal Traveler / preorder
	[3128] = true, -- Stormrider's Attire / preorder
	[3129] = true, -- Thundering Stormrider's Attire / preorder
	[3451] = true, -- Gladiator's Ragged Armor promotion
	[3634] = true, -- Green Murloc Romper promotion
	[4206] = true, -- Shining Vestments of the Heavens promotion
	[4207] = true, -- Shining Vestments of the Heavens promotion
	[4370] = true, -- Stormstout Collection promotion
	[4550] = true, -- Wings and Wisdom promotion
	[4551] = true, -- Wings and Wisdom promotion
	[5335] = true, -- Scorching Conqueror regional promotion
}
