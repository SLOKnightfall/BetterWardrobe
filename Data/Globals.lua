...
Globals.TABS_MAX_WIDTH = 275
 ...
 Globals.FILTER_SOURCES = {L["MISC"], L["Classic Set"], L["Quest Set"], L["Dungeon Set"], L["Raid Recolor"], L["Raid Lookalike"], L["PvP"],L["Garrison"], L["Island Expedition"], L["Warfronts"], L["Covenants"]}
